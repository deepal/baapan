...
function startRepl() {
  ...
  const replHistorySize = process.env.NODE_REPL_HISTORY_SIZE ? parseInt(process.env.NODE_REPL_HISTORY_SIZE, 10) : 1000;
  ...
  if (typeof (process.env.NODE_REPL_HISTORY) === 'undefined' || process.env.NODE_REPL_HISTORY !== '') {
